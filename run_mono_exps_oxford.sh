...
#d=$(date +%Y%m%d%H%M)
python3 run_mono_training.py --flow_type 'classical' --max_depth 5 --stereo_baseline 0.24 --camera_height 1.52 --pretrained_plane_dir 'results/plane-model-eigen-202101201842' --data_dir '/mnt/datadisk/andreim/oxford_robotcar_downsized' --estimator 'stereo' --estimator_type 'mono' --train_seq 'all'  --val_seq '2014-11-18-13-20-12_0' --test_seq '2014-11-18-13-20-12_1' --date $d --lr 1e-4 --wd 0 --num_epochs 20 --lr_decay_epoch 12 --save_results
