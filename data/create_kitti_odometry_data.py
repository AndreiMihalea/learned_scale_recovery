...
parser.add_argument("--source_dir", type=str, default='/mnt/storage/workspace/andreim/kitti/data_odometry_color/dataset')
parser.add_argument("--target_dir", type=str, default='/mnt/storage/workspace/andreim/kitti/kitti_odometry_downsized')
