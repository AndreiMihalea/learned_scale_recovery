...
python3 run_mono_training.py --img_resolution 'med' --flow_type 'classical' \
 ...
 --date $d --name kitti_odom_pre1_$method --lr 1e-4 --wd 0 --num_epochs 25 --lr_decay_epoch 4 \
...
#   --estimator 'orbslam' --estimator_type 'mono' --date $d --name kitti_eigen_prefull_$method \
